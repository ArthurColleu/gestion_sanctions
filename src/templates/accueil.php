<div class="container">
    <div class="row">
        ...
        <div class="col col-12 col-lg-6">
            <img src="./images/logo_lycee_Gaudper.png" alt="Logo gaudper" width="120" height="400"
